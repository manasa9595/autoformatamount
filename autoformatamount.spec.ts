...
import { AutoComplete } from './autoformatamount';
...
@Component({
	template: `<p-autoformat-amount [(ngModel)]="brand" [suggestions]="filteredBrands" (completeMethod)="filterBrands($event)"></p-autoformat-amount>
  <a (click)="deleteLastEl()"></a>
  <p-autoformat-amount [(ngModel)]="car" [suggestions]="filteredCars" (completeMethod)="filterBrandsWithField($event)"></p-autoformat-amount>
  `
})
